...
class TestFileHandling:
    ...
    def test_allowed_extensions(self):
        ...
        valid_files = [
            "audio.mp3", "video.mp4", "test.wav", "file.m4a",
            "movie.mov", "clip.avi", "stream.webm"
        ]
        
        invalid_files = [
            "document.pdf", "image.jpg", "text.txt", "archive.zip"
        ]
...
class TestUtilityFunctions:
    ...
    def test_chunk_calculation(self):
        ...
        for duration, expected_chunks in test_durations:
            ...
            assert actual_chunks == expected_chunks, f"Duration {duration}s should produce {expected_chunks} chunks, got {actual_chunks}"
...
class TestIntegration:
    ...
    def test_complete_workflow(self, mock_openai_client, temp_dir, sample_audio_data, mock_env_vars):
        """Test kompletnego workflow przetwarzania."""
